export const DEFAULT_CODES_CH41: Record<string, string> = {
  error_handling_typed_contracts: `use std::collections::HashMap;
use thiserror::Error;
...
fn main() {
  ...
  error_handling_async_context: `use anyhow::{Context, Result};
