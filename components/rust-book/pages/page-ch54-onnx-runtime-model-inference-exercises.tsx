...
const exercises: Exercise[] = [
  {
    ...
    title: "Identify what the session owns and what you own",
  ...
  },
  {
    ...
    starterPrompt: "A colleague's session run sometimes errors and sometimes returns confident nonsense because they changed the input builder. The graph declares a named input of shape [4] with dtype f32, but their code now passes a length-3 vector in one path and an i64 buffer in another. Explain each failure and fix the contract.",
    prompts: [
