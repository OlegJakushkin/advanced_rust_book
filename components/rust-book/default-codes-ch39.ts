export const DEFAULT_CODES_CH39: Record<string, string> = {
  graph_search_bfs_handles: `use std::collections::VecDeque;
...
fn main() {
  ...
  graph_search_dijkstra_astar: `use std::cmp::Ordering;
