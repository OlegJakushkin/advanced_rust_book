export const DEFAULT_CODES_CH50: Record<string, string> = {
  libp2p_swarm_state_machine: `use std::collections::{BTreeSet, HashMap, VecDeque};
...
fn main() {
  ...
  libp2p_state_sync_conflicts: `#[derive(Debug, Clone, PartialEq, Eq)]
